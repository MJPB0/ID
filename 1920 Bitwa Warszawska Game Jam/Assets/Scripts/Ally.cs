...
public class Ally : MonoBehaviour
{
    ...
    void GiveItem()
    {
        for (int i = 0; i < inventorySpace; i++)
        {
            ...
            {
                playerInventory.AddItem(itemHeGives.GetComponentInChildren<ItemPickup>().itemInfo, i);
                gameUI.AddItemToUIGameInventory(itemHeGives.GetComponent<ItemPickup>().itemInfo, i);
                gaveItem = true;
                break;
            }
        }
